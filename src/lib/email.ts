      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="padding:0 0 24px;">
          ...
          <p style="font-size:14px;color:#8a8580;margin:0;line-height:1.6;">
            Thank you for using the Neon Commerce DTC revenue calculator. We've analyzed ${publisherName}'s portfolio to estimate how much more you could earn by going direct. Here's what we found.
          </p>
        </td></tr>
        ...
        <tr><td style="text-align:center;padding:32px 0;">
          ...
          <p style="font-size:13px;color:#8a8580;margin:0 0 20px;max-width:400px;margin-left:auto;margin-right:auto;">
            ${firstName ? `${firstName}, we'd` : "We'd"} love to show you how Neon Commerce can help ${publisherName} go direct and keep more of what your players spend.
          </p>
        ...
        <tr><td style="text-align:center;padding:24px 0;border-top:1px solid #2e2e2e;">
          <p style="font-size:11px;color:#8a8580;margin:0;">
            This report was generated by Neon Commerce.
...
<body style="margin:0;padding:0;background-color:#1a1a1a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#e8e4df;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background-color:#222222;border:1px solid #2e2e2e;padding:32px;">
          ...
          <p style="font-size:14px;color:#8a8580;margin:0 0 16px;line-height:1.6;">
            Thank you for trying the Neon Commerce DTC revenue calculator. We weren't able to automatically match your company (${domain}) to our database of mobile game developers — but that doesn't mean we can't help.
          </p>
          <p style="font-size:14px;color:#8a8580;margin:0 0 16px;line-height:1.6;">
            Our team can run a custom analysis for your studio, estimating how much additional revenue you could earn by going direct with Neon Shop, Neon Checkout, or Neon Direct Checkout.
          </p>
          <p style="font-size:14px;color:#8a8580;margin:0;line-height:1.6;">
            We'd also be happy to show you how Neon gives game developers full visibility, flat-rate predictable fees, and the freedom to operate without restrictions.
          </p>
        </td></tr>
        ...
        <tr><td style="background-color:#222222;border:1px solid #2e2e2e;padding:24px;margin-top:1px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td style="padding:8px 0;font-size:13px;color:#8a8580;">Walk you through a live demo of Neon Commerce</td>
            </tr>
          </table>
        </td></tr>
        ...
        <tr><td style="text-align:center;padding:24px 0;border-top:1px solid #2e2e2e;">
          <p style="font-size:11px;color:#8a8580;margin:0;">
            This email was sent by Neon Commerce.
          </p>
        </td></tr>
  ...
  const { data, error } = await resend.emails.send({
    from: "Neon Insights <onboarding@resend.dev>",
    to: DEMO_RECIPIENT,
    subject: `${firstName ? `${firstName}, ` : ""}See how much more you could earn going direct with Neon`,
    html,
    scheduledAt: getScheduledAt(),
  });
